...
<script type="text/javascript" src="../js/addbuilder.js"></script>
</head>
	...
	<div class="section">
		...
		<form action="../db_code/insertStudentInfo.php" method="post"
			...
			<div class="container">
					...
					<div class="col-md-12" id="bank">
						<div class="col-md-4">
							<div class="form-group">
								<label class="control-label" for="exampleInputfname">Marka</label>
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label text-center" >Rate per 1000</label>
						<input class="form-control" id="name" placeholder="Name"
							type="text" name="name" maxlength="30" required>
					</div>
					</div>
				<div class="col-md-4"></div>
				</div>
